...
public class PutEmployee extends AbstractIntegrationTest {
    ...
    void putEmployee() throws Exception {
        ...
        final var contentAsString = this.mockMvc.perform(put("/project/1/employee/9/qualification/weise")
                        .header("Authorization", bearerToken))
                .andExpect(status().is2xxSuccessful())
                .andExpect(jsonPath("employees", hasSize(1)))
                .andExpect(jsonPath("employees[0]", is(9)));
    }
}
